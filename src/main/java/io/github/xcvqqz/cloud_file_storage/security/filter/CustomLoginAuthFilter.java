...
public class CustomLoginAuthFilter extends BasicAuthenticationFilter {

    private static final String LOGIN_URL = "/api/auth/sign-in";

    public CustomLoginAuthFilter(AuthenticationManager authenticationManager, ObjectMapper objectMapper) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(!isLoginRequest(request, LOGIN_URL)){
